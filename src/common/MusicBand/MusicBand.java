...
/**
 * Шаблон класса common.MusicBand. Содержит геттеры и сеттеры для всех полей
...
public class MusicBand implements Serializable {
    ...
    public void setId(Integer id) {
        if (validation.validateID(id)) {
            this.id = id;
        } else throw new IllegalArgumentException("ID не может принимать значение null и быть неположительным числом, а также должен принимать уникальные значения!");
    }
